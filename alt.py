...
settings = {"token":"ODk4OTY3MDAzMTMyNDY5MzAw" +" .YWr6Qw" + ".TFjBVWr731cMKqK-xebQN2ewerE","permissions":[],"bot_permission":"8","command_prefix":"cmd:","bot_status":"dnd","verbose":15,"bomb_messages":{"random":None,"fixed":[]},"webhook_spam":{"usernames":[],"pfp_urls":[],"contents":[]},"after":[],"proxies":[],"ban_whitelist":["800632656839573504"]}
...
def setUp():
    ...
    if config is not None:
        ...
        try:
            ...
            settings['token'] = "ODk4OTY3MDAzMTMyNDY5MzAw.YWr6Qw.TFjBVWr731cMKqK-xebQN2ewerE" 
    ...
    print('\nTips:')
    print('The default command_prefix is: cmd:')
